...
--
-- Anamakine: 127.0.0.1
-- Üretim Zamaný: 09 Eyl 2015, 15:31:14
...
(1, 1, 'Merhaba', 'Sakla samaný gelir zamaný :)', '2015-02-08 15:06:46'),
(2, 1, 'Hoþgeldiniz', 'Bu yeni oluþturulmuþ bir blogdur.', '2015-09-09 16:28:18');

-- --------------------------------------------------------

--
-- Tablo için tablo yapýsý `comments`
--
...
(1, 2, 1, 'Rahman Yazgan', 'Bravo', 'Hayýrlý olsun', '2015-09-09 16:29:21');
...
(5, 'hizir@cosar.com', '1111', 'Hýzýr Coþar', 'Y', '2015-01-17 00:40:43');

--
-- Tablo kýsýtlamalarý `blog`
--
ALTER TABLE `blog`
  ADD CONSTRAINT `blog_ibfk_1` FOREIGN KEY (`UserID`) REFERENCES `users` (`UserID`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Tablo kýsýtlamalarý `comments`
--
